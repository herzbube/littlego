...
// -----------------------------------------------------------------------------
/// @brief The UiTestDeviceInfo class is used by user interface tests (UI tests)
/// to obtain characteristics about the device under test.
// -----------------------------------------------------------------------------

@interface UiTestDeviceInfo : NSObject
