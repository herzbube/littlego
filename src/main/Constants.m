...
NSString* menuHamburgerButtonIconResource = @"menu-hamburger.png";
...
NSString* focusModeKey = @"FocusMode";
...
NSString* boardPositionCollectionViewCellAccessibilityIdentifier = @"Board position collection view cell";
NSString* textLabelBoardPositionAccessibilityIdentifier = @"Text label";
NSString* detailTextLabelBoardPositionAccessibilityIdentifier = @"Detail text label";
NSString* capturedStonesLabelBoardPositionAccessibilityIdentifier = @"Captured stones label";
NSString* hotspotIconImageViewBoardPositionAccessibilityIdentifier = @"Hotspot icon image view";
NSString* infoIconImageViewBoardPositionAccessibilityIdentifier = @"Info icon image view";
NSString* markupIconImageViewBoardPositionAccessibilityIdentifier = @"Markup icon image view";
NSString* noNodeImageViewBoardPositionAccessibilityIdentifier = @"No node image view";
NSString* emptyNodeImageViewBoardPositionAccessibilityIdentifier = @"Empty node image view";
NSString* blackSetupStonesNodeImageViewBoardPositionAccessibilityIdentifier = @"Black setup stones node image view";
NSString* whiteSetupStonesNodeImageViewBoardPositionAccessibilityIdentifier = @"White setup stones node image view";
NSString* clearSetupStonesNodeImageViewBoardPositionAccessibilityIdentifier = @"Clear setup stones node image view";
NSString* blackAndWhiteSetupStonesNodeImageViewBoardPositionAccessibilityIdentifier = @"Black and white setup stones node image view";
NSString* blackAndClearSetupStonesNodeImageViewBoardPositionAccessibilityIdentifier = @"Black and clear setup stones node image view";
NSString* whiteAndClearSetupStonesNodeImageViewBoardPositionAccessibilityIdentifier = @"White and clear setup stones node image view";
NSString* blackAndWhiteAndClearSetupStonesNodeImageViewBoardPositionAccessibilityIdentifier = @"Black and white and clear setup stones node image view";
NSString* blackMoveNodeImageViewBoardPositionAccessibilityIdentifier = @"Black move node image view";
NSString* whiteMoveNodeImageViewBoardPositionAccessibilityIdentifier = @"White move node image view";
NSString* annotationsNodeImageViewBoardPositionAccessibilityIdentifier = @"Annotations node image view";
NSString* markupNodeImageViewBoardPositionAccessibilityIdentifier = @"Markup node image view";
NSString* annotationsAndMarkupNodeImageViewBoardPositionAccessibilityIdentifier = @"Annotations and markup node image view";
NSString* handicapNodeImageViewBoardPositionAccessibilityIdentifier = @"Handicap node image view";
NSString* komiNodeImageViewBoardPositionAccessibilityIdentifier = @"Komi node image view";
NSString* handicapAndKomiNodeImageViewBoardPositionAccessibilityIdentifier = @"Handicap and komi node image view";
NSString* rootNodeImageViewBoardPositionAccessibilityIdentifier = @"Root node image view";
...
NSString* playRootViewNavigationBarAccessibilityIdentifier = @"playRootViewNavigationBar";
