...
const int bugReportFormatVersion = 8;
...
// Game setup settings
NSString* gameSetupStoneColorKey = @"GameSetupStoneColor";

// Constants for NSCoding
// General constants
const int nscodingVersion = 8;  // if you change this, also change bugReportFormatVersion
