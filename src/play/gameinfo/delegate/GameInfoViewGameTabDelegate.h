...
// -----------------------------------------------------------------------------
/// @brief The GameInfoViewGameTabDelegate class is responsible for managing
/// the "Game" tab in the "Game Info" screen.
// -----------------------------------------------------------------------------
@interface GameInfoViewGameTabDelegate : NSObject <UITableViewDelegate,
