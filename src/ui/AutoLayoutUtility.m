...
// -----------------------------------------------------------------------------
/// @brief Adds Auto Layout constraints to the superview of @a firstView that
/// specify that @a firstView is horizontally and vertically centered in
/// @a secondView. Returns the constraints generated by this method.
// -----------------------------------------------------------------------------
+ (NSArray*) centerFirstView:(UIView*)firstView
                inSecondView:(UIView*)secondView
{
  NSLayoutConstraint* constraint1 = [AutoLayoutUtility alignFirstView:firstView
                                                       withSecondView:secondView
                                                          onAttribute:NSLayoutAttributeCenterX
                                                     constraintHolder:firstView.superview];
  NSLayoutConstraint* constraint2 = [AutoLayoutUtility alignFirstView:firstView
                                                       withSecondView:secondView
