...
// -----------------------------------------------------------------------------
/// @brief Adds an Auto Layout constraint to @a constraintHolder that sets the
/// height of @a view to 0 (zero). The constraint is assigned priority
/// @e UILayoutPriorityRequired. Returns the constraint generated by this
/// method.
// -----------------------------------------------------------------------------
