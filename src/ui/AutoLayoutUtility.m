...
/// @a view to have the same width and height. Returns the constraint generated
/// by this method.
// -----------------------------------------------------------------------------
...
// -----------------------------------------------------------------------------
/// @brief Adds an Auto Layout constraint to @a constraintHolder that causes
/// @a view to have the width-to-height aspect ratio specified by @a multiplier.
/// Returns the constraint generated by this method.
///
/// Calculate the multiplier by dividing the width by the height portion of the
/// desired aspect ratio. For instance, if the desired aspect ratio is 16:9,
/// supply the result of 16 divided by 9 as the value for @a multiplier.
///
/// If @a multiplier is 1.0f then @a view will be square. If @a multiplier is
/// greater than 1.0f then @a view will be wider than high. If @a multiplier is
/// less than 1.0f then @a view will be higher than wide.
// -----------------------------------------------------------------------------
