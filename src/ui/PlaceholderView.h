...
///
/// PlaceholderView divides its height into thirds and places the placeholder
/// label so that its top edge starts after one third. The result is a generous
/// spacing of one third at the top and the label gets sufficient vertical space
/// in case longer texts are shown.
///
/// @verbatim
/// +--PlaceholderView-------------+
/// | +-One third----------------+ |
